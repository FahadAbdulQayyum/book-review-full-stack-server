...
import { ADD_BOOK, DELETE_BOOK, UPDATE_BOOK, SET_CURRENT, CLEAR_CURRENT, FILTER_BOOK, CLEAR_FILTER, BOOK_ERROR, GET_BOOKS, CLEAR_BOOKS, API } from '../types';
...
const BookState = props => {
    ...
    const getBooks = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const res = yield axios.get(`${API}/api/books`, config);
    ...
    const addBook = (book) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const res = yield axios.post(`${API}/api/books`, book, config);
    ...
    const deleteBook = (id) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield axios.delete(`${API}/api/books/${id}`, config);
            dispatch({ type: DELETE_BOOK, payload: id });
        }
        catch (err) {
            console.log(err);
    ...
    const updateBook = (book) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const res = yield axios.put(`${API}/api/books/${book._id}`, book, config);
    ...
    const setCurrent = (book) => dispatch({ type: SET_CURRENT, payload: book });
    const clearCurrent = () => dispatch({ type: CLEAR_CURRENT });
    const filterBook = (text) => dispatch({ type: FILTER_BOOK, payload: text });
    ...
    // Filter Book
    // Clear Filter
    return (_jsx(bookContext.Provider, { value: {
            books: state.books,
